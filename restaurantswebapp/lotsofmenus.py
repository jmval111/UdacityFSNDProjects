...
restaurant1 = Restaurant(name="Urban Burger", location="Bandra, Mumbai", description="Veg, non veg burgers for taste hungry people")
...
restaurant2 = Restaurant(name="Super Stir Fry", location="Tardeo, Mumbai", description="Specialized in soups and noodles!")
...
restaurant1 = Restaurant(name="Panda Garden", location="Pune", description="Spicy Chinese delicacies.")
...
restaurant1 = Restaurant(name="Thyme for That Vegetarian Cuisine", location="Matunga, Mumbai", description="Tasty Italian cuisines")
...
restaurant1 = Restaurant(name="Tony\'s Bistro", location="Vasai", description="Family dining")
...
# Menu for Andala's
restaurant1 = Restaurant(name="Andala\'s", location="Mumbai", description="Tasty food with Indian spices")
...
restaurant1 = Restaurant(name="Auntie Ann\'s Diner", location="Goa", description="Goa's favorite dinner place")
...
restaurant1 = Restaurant(name="Cocina Y Amor", location="Goa", description="Traditional Spanish Cuisine")
...
restaurant1 = Restaurant(name="State Bird Provisions", location="Mumbai", description="Family Restaurant")
session.add(restaurant1)
session.commit()
